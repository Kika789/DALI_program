// Tento kod rozblikava svetelne zarizeni a ledku na mikrokontroleru, kazdy zvlast ma definovane stav a cas
//----------------------------- 
#include <Arduino.h>
...
unsigned long cas=0;     // promena pro zapamatovani stavu casu
...
//----------------------------------------------------------------------
  ...
  if(svetlo){          // blikani svetel
    if(millis()>cas_svetlo){
        ...
        cas_svetlo=millis()+1000;     // tento prikaz ma delat co presne???
    }
  }
}
// -----------------------------------konec
