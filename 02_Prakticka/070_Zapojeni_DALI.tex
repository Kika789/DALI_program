...
\begitems
    ...
    * {\sbf Napájení řídicí jednotky:} Dva nezávislé napájecí zdroje 12 V byly připojeny k~napájecím konektorům řídící jednotky.
...
\begitems
    * Inicializace zařízení a adres
      ...
      Každému světlu byla přiřazena jedinečná adresa v rámci komunikační sítě.
...
\begitems
    * {\sbf set failure system (180):}
        Nastaví úroveň jasu světelných zařízení při výpadku mikrokontroléru.
...
\medskip\noindent
První scéna - dva světelné prvky byly nastavené na intenzitu jasu 200 a dva zbylé byly vypnuté
