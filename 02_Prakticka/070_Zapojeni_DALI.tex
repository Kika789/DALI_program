...
\begitems
    * Každému světlu byla přiřazena jedinečná adresa v rámci komunikační sítě. Adresy
        byly konfigurovány pomocí příkazu identify a ověřeny pozorováním reakce zařízení (rozblikání na 10 sekund).
...
\medskip\noindent
{\sbf Implementace scénářů:}
\begitems
    * Pro tlačítka byla vytvořena sada scénářů, které definují chování světel při stisknutí daného tlačítka.
        Scénáře zahrnují funkce jako zapnutí/vypnutí, stmívání/zesilování a nastavení barevných teplot.
    * Implementace scénářů byla provedena v programovacím prostředí pro mikrořadič ESP32 WROOM,
...
\begitems \style o
    ...
    * tlačítko {\sbf Písemka:} dva světelné prvky jsou nastaveny na vyšší intenzitu a~dva nižší intenzitu.
    * tlačítko {\sbf Denní světlo:}  každý prvek je nastaven s jinou intenzitou - od nejnižší po nejvyšší.
    * tlačítka {\sbf Regulace jasu:} kdy při dlouhem stisku se intenzita zvysovala/snizovala
\enditems
