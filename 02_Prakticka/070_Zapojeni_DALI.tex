...
\noindent {\sbf Nastavení tlačítka off}
 ...
 Tlačítko {\tt Off} slouží k úlnému vypnutí světel
...
Tlačítka regulace jasu slouží k postupnému zvyšování nebo snižování intenzity jasu světel.
Jas se zvýši nebo sníží o krok při každém překročení časového intervalu 30~ms.
