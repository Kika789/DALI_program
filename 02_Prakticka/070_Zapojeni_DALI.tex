...
\begitems
    ...
    * {\sbf ESP--IDF (Espressif IoT Development Framework):} ESP--IDF je oficiální vývojové prostředí pro mikrokontroléry ESP32.
        Umožňuje programování v jazycích C a~poskytuje širokou škálu funkcí pro vývoj softwaru~\cite[noauthor_espidf].
\enditems
...
\secc Inicializace řídící jednotky:


\medskip\noindent
{\sbf Vybrané piny:}

\medskip \clabel[esp32_wroom]{Piny u ESP32 WROOM}
\picw=10cm \cinspic 03_Obrazky/esp32_wroom.png
\caption/f Piny u ESP32 WROOM \cite[esp32_wroom]
\medskip
...
\endtt
    ...
    * Funkce {\sbf SetScene (dev, scene, jas):}
...
\medskip\noindent
{\sbf První scéna} - dva světelné prvky s unikátní adresou 1 a 2 byly nastavené na intenzitu jasu 200 a dva zbylé byly vypnuté
...
\noindent
{\sbf Druhá scéna} - dva světelné prvky s unikátní adresou 0 a 2 byly nastavené na vyšší intenzitu jasu 200 a dva zbylé (unikátní adresa 1 a 3) byly na nižší 120
...
\noindent {\sbf Nastavení tlačítka off} - slouží k ṕlnému vypnutí světel
