...
\begitems
    * Navrhli jsme intuitivní ovládání světelného systému pomocí tří tlačítek pro různé světelné scény.
    * Otestovali jsme funkčnost řídící jednotky a tlačítek a implementovali scény.
    * V laboratoři jsme pracovali se čtyřmi světelnými zařízeními s protokolem DALI.
    * Testy ukázaly jednodušší ovládání pro uživatele bez náhodného zapnutí/vypnutí.
    * Uživatelé snadno poznají, jak světla vypnout.
