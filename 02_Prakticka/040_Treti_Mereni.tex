...
Na obrázku \ref[svet_mapa0] vidíme světelnou mapu zapnutých všech světel na maximální intenzitě.
Z hodnot intenzity osvětlení na isofotech je patrné, že osvětlenost je nejnižší u~oken a~nejvyšší uprostřed místnosti.
% abychom měli představu o chování světla v celém prostoru.

\medskip \clabel[svet_mapa0]{Světelná mapa kombinovaného osvětlení}
\picw=8cm \cinspic 04_Grafy/03_mereni/max_01_MAX_kombi_max_2d.jpg
...
Následující grafy ukazují rozložení osvětlení (v luxech) v učebně. Nejprve s maximálním výkonem všech světel a~poté s kombinací,
...
\begitems
  * První graf zobrazuje rozložení osvětlenosti v učebně při zapnutí všech světel na maximum. Je zřejmé, že takto vysoké hodnoty luxů
    ...
    které absorbují světlo a blokují přirozené denní světlo.
...
\begitems
    * Na základě měření můžeme usuzovat, že všechny řady svítidel přispívají k osvětlení učebny relativně rovnoměrně.
...
\begitems
    * Průběhy ukazují, že v učebně je osvětlení relativně rovnoměrné rozložené.
...
\begitems
  *  Z grafu je patrné, že přímé osvětlení do prostoru přispívá méně. Je to způsobeno několika faktory.
