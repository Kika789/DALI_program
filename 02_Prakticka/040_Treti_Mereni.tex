...
Celkem bylo zvoleno devět světelných scén a~změřeno 18 vybraných měřicích bodů ve výšce 850mm.
...
\medskip \noindent {\sbf Graf 1 (\ref[svet_mapa]): Světelná mapy kombinovaného osvětlení}
...
\medskip \noindent {\sbf Graf 2 (\ref[svet_mapa]): Světelná mapy nepřímého osvětlení}
...
\medskip \noindent {\sbf Graf 3 (\ref[svet_mapa]): Světelná mapy přímého osvětlení}
