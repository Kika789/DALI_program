...
Na grafu (\ref[svet_mapa0]) vidíme světelnou mapu zapnutých všech svítidel na maximální intenzitě,
abychom měli představu o chování světla v celém prostoru.

\medskip \clabel[svet_mapa0]{Světelná kombinovaného osvětlení1}
...
\medskip \noindent {\sbf Analýza grafů:}

První graf (\ref[svet_mapa0]) zobrazuje rozložení osvětlenosti v učebně při zapnutí všech svítidel na maximum. Je zřejmé, že takto vysoké hodnoty luxů (nad 1000 luxů)
...
% Toto měření bylo provedeno z důvodu, abych věděli jak jednotlivá řada přispívá do prostoru se svým světlem.
% Na prvním grafu vidíme, že luxy jsou velmi vysoké a nejsou vhodné pro běžné používaní, ale to jen z důvodu, že jsou na maximální
% hodnotě. Osvětlenost u okna je tmavší než jinde, protože jsou zatažená černými latkovými roletami, které absorbují světlo.

\medskip \noindent {\sbf Graf \ref[svet_mapa]: Světelná mapy kombinovaného osvětlení}
...
\medskip \noindent {\sbf Graf \ref[svet_mapa2]: Světelná mapy nepřímého osvětlení}
...
\medskip \noindent {\sbf Graf \ref[svet_mapa3]: Světelná mapy přímého osvětlení}
