...
\caption/f Simulace scény {\sbf výklad}. Vlevo srovnávací rovina 800~mm, vpravo strop. Isofoty v luxech.
\medskip
...
\caption/f Simulace scény {\sbf písemka}. Vlevo srovnávací rovina 800~mm, vpravo strop. Isofoty v luxech.
\medskip
...
světla s kombinací umělého osvětlení a~vpravo výsledky simulace ze zatažené oblohy.

\medskip \clabel[simulace2]{Simulace scény denní světlo}
\picw=18cm \cinspic 04_Grafy/05_simulace/sceny/030_svetlo1.png
\caption/f Simulace scény {\sbf denní světlo}. Vlevo denní a umělé osvětlení, vpravo zatažená obloha. Srovnávací rovina 800~mm. Isofoty v luxech.
\medskip
...
osvětlení 5470~K vytváří příjemnou atmosféru, která podporuje soustředění studentů.
