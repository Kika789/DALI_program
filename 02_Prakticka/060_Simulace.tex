...
\begitems
    ...
    * Porovnáváme kombinované, nepřímé a přímé osvětlení mezi měřením a simulaci.
...
Důvodem je, že simulační rovina byla umístěna do výšky lavic.
...
Na základě validačních výsledků můžeme teď přistoupit k optimalizaci parametrů osvětlení v učebně pro různé scény.
