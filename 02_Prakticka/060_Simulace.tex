...
Na základě úspěšných validačních výsledků lze přistoupit k optimalizaci parametrů osvětlení v učebně pro různé scény.

\sec Simulace - Výklad

V této sekci se budeme zabývat simulací osvětlení v učebně, které označíme jako {\sbf Výklad}.
Pro tento typ činnosti byl zvolen typ nepřímého osvětlení.

\noindent {\sbf Parametry a cíle pro simulaci:}
\begitems
* {\sbf Typ osvětlení:} {Nepřímé.}
* {\sbf Cíl:} Zajistit měkké a rovnoměrné osvětlení,
        které minimalizuje oslnění a~umožňuje studentům snadno vidět na tabuli a učitele.
* {\sbf Osvětlení:} Požadavkem je, aby intenzita osvětlení na tabuli
a v prostoru pro učitele byla 300--500 luxů a vyhnout se přímému osvětlení tabule,
které by mohlo způsobovat oslnění.
\enditems
...
V této sekci se budeme zabývat simulací osvětlení v učebně, které označíme jako {\sbf Písemka}.
Pro tento typ činnosti byl zvolen typ kombinovaného osvětlení.
