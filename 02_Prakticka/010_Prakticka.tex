...
která byla zaměřena na optimalizaci osvětlení pro výuku biologie.
...
Tyto simulace umožnily detailně zohlednit rozložení světla v~prostoru a~jeho dopad na uživatele, což bylo
...
\sec Popis učebny
Pro analýzu v praktické části byla zvolena výuková místnost na gymnáziu U~Libeňského zámku (viz obr.~\ref[ucebna] a~\ref[pudorys]), kde probíhá výuka
...
a~16 lavicemi pro 32 žáků. Učebna je osvětlovaná v~plném rozsahu i~při nižším počtu žáků. Strop, zadní stěna
a~stěna u~oken jsou bílé barvy a~zbývající dvě stěny jsou světle oranžové. Podlaha je světle hnědé barvy a okna jsou orientovaná na západ.
...
Osvětlení je nyní možné ovládat pomocí dvanácti tlačítek, která umožňují nezávislou plynulou regulaci
světelného výkonu každého jednotlivého segmentu. Toto ovládání způsobuje složitější ovládání a~potíže novým uživatelům.
...
\caption/t Parametry světel~\cite[spectrasol]
\endinsert
...
\begitems
    ...
    * {\sbf Scéna -- Adaptace na denní světlo:} Implementovat scénu, která by se přizpůsobila
...
\picw=12cm \cinspic 03_Obrazky/ucebna2a.jpg
\caption/f Učebna
\medskip

\medskip \clabel[pudorys]{Půdorys učebny}
\picw=15cm \cinspic 03_Obrazky/vykres03.jpg
