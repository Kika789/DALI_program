...
z~plnospektrálního \glref{LED} nepřímého osvětlení a~přímého LED osvětlení s~nižší teplotou chromatičnosti.
...
\medskip
V~učebně, s parametry podle tab.~\ref[param_ucebny], jsou nainstalovaná světla: EVA - LED linear light
% \mnote{\inoval{odkaz}}
