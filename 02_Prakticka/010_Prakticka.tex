...
Ovládání aktuálního stavu světelného zařízení v~učebně (\ref[ucebna]) je řešeno dvanácti tlačítky, což způsobuje složitější ovládání
...
\medskip\noindent
Po diskuzi s~učiteli bylo navrženo nastavit:
\begitems
