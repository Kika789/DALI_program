...
Inteligentní osvětlení se stává běžnou součástí moderních interiérů a~odborné studie prokazují jeho schopnost
podpořit koncentraci, zvýšit produktivitu a~celkově přispět ke zdraví.
...
Vystavovat se modrému světlu po západu Slunce je pro nás nepřirozeným jevem. Během dne je naopak důležité správné
zastoupení azurových vlnových délek ve světle.
...
% Práce zahrnuje technické a světelně hygienické požadavky, zrakový komfort
% a~biologické potřeby studentů, a také návrh implementace sběrnicového systému pro snadnou regulaci osvětlení.

\medskip \medskip \medskip

Práce v první kapitole popisuje různé typy umělého
...
Druhá kapitola podrobně popisuje fyziologii vidění, zahrnující
...
Třetí kapitola pojednává o~přenosovém protokolu \glref{DALI}, který
využívá Manchester kódování s~přenosovou rychlosti 1200 bps \cite[manchester_code].
...
V kapitole 4 a 5 diplomové práce byla provedena analýza umělého osvětlení ve školní učebně
...
V kapitole 6 byla provedena simulace osvětlení učebny v programu DIALux,
...
Kapitola 7 se zaměřuje na návrh optimalizovaného světelného ovládání pro učebnu,
...
řídicí jednotky s~mikrokontrolérem \glref{ESP32} WROOM spolu s~programováním scén pro různé účely.
