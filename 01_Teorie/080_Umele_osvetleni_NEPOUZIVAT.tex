...
% kdyztak se inspirovat od Krause diplomky
% \medskip
\begitems
...
\enditems
\sec Světlo
% Světlo je elektromagnetické záření, které si můžeme představit jako energii, která prochází vzduchem se specifickou
% frekvencí nebo vlnovou délkou. Čím kratší je vlnová délka, tím více energie vlna obsahuje a~čím delší je
% vlnová délka, tím hlouběji může vlna proniknout do lidské tkáně.
...
% \medskip
\clabel[ss]{Šíření světla}
\picw=10cm \cinspic 03_Obrazky/vlna.png
\caption/f Šíření světla
% \medskip

% Celé spektrum světla, nazývané také elektromagnetické spektrum, zahrnuje četné vlnové délky světla s různými frekvencemi a~barvami,
% jako je například červené světlo (v rozsahu okolo 650 nm) a~modré světlo (v rozsahu 380-500 nm). Světelné spektrum zahrnuje
% jak viditelné světlo, které je viditelné lidským okem, jako je například ono červené a~modré světlo, tak také neviditelné světlo,
% jako například blízké infračervené světlo (NIR). Viditelná barva světla vychází také z délky vlny a~z toho, jak je vnímají naše oči.
% Energie ve světle závisí na vlnové délce a~barva je tím, jak lidské oko a~mozek dávají smysl elektromagnetickým vlnovým délkám světla.
% Viditelné spektrum světla tvoří velmi malou část veškerého elektromagnetického záření.
% Světlo ze zdrojů, které běžně používáme k osvětlování (žárovky, zářivky nebo i~Slunce), ovšem nevnímáme jako barevné,
% ale označujeme ho jako bílé světlo. Je to světlo složené z barevných světel všech vlnových délek.
% Bílé světlo, popř. světlo určité barvy, můžeme získat i~mísením menšího počtu barev. Např. obraz barevné televize vzniká
% mísením světel tří barev červené, zelené a~modré.


Elektromagnetické spektrum, rozsah světla, zahrnuje různé vlnové délky s~různými frekvencemi a~barvami od ultrafialového
až po infračervené světlo (obr. \ref[bs]).
...
\clabel[lumen-cadela-lux]{lumen-cadela-lux}
\picw=10cm \cinspic 03_Obrazky/lumen-cadela-lux.png
...
% \medskip
% Dalšími veličinami pro hodnocení umělého osvětlení jsou:

% \medskip
% \begitems
%     * {\sbf udržovaná osvětlenost Ēm [lx]} - průměrná hodnota osvětlenosti, pod kterou nesmí osvětlenost poklesnout v okamžiku provedení naplánované údržby (obvykle očištění zdroje, obnova vnitřních povrchů místnosti, výměna zdroje).;
...
%     * {\sbf teplota chromatičnosti $T_{cp}$} - také nazývaná jako barevná teplota, udává barvu světla v jednotkách Kelvinů, které se označují písmenem K. ;
%     * {\sbf všeobecný index podání barev Ra} - index podání barev (CRI - Color Rendering Index) měří podobnost podání barev umělého osvětlení se slunečním světlem. Čím vyšší CRI, tím realističtěji vypadají barvy pod daným osvětlením.
%     * {\sbf míhání světla }- změnu světelného toku světelného zdroje nebo svítidla vlivem výkyvů napětí jeho napájecího zdroje.
% \enditems
% \medskip
...
V~nových a~rekonstruovaných objektech školských zařízení musí vyhovovat dennímu osvětlení dle normových
...
Povrchy pracovních ploch se navrhují vždy s~rozptylnou, nelesklou úpravou. Doporučuje se, aby měli hodnoty
...
% \secc Přehled jednotek používaných k měření světla:
% Candela
% je úroveň jasu světelného zdroje v určitém úhlu a~směru.
% \medskip
% Lumen udává celkový výkon světla ve všech směrech.
% \medskip
% Lux Množství osvětlení, které dopadá na metr čtvereční plochy.
% \medskip
% Nejběžnějším vztahem mezi těmito třemi pojmy je, že všechny jsou měrnou jednotkou světla.
% \medskip
% Lumens je odvozená forma Candela. Oba pojmy měří světelnost; to znamená, že uvádějí jas světelného zdroje. Rozdíl je v tom, že lumeny berou v úvahu světelné paprsky ze všech směrů. Naproti tomu Candela to považuje za určitý směr.
% \medskip
% Jednotka Lux je opět míra lumenů na metr čtvereční. Je to odvozená forma Lumenů. Matematicky,
% $1 lx = 1 lm/m^2$. Tato rovnice poskytuje přesnější vyjádření jasu světla než Lumeny.
% \medskip
% Lux -> Lumen -> Candela
% $1 lx = 1 lm/m2 = 1 cd·sr/m2$
% \medskip
% Candela, Lux a~Lumens jsou tedy vzájemně propojeny. Přesto uvádějí tři samostatné identity, ale jsou propojené a~konvertibilní.
% \medskip
% Plná koule má prostorový úhel 4π steradiánů, takže světelný zdroj, který rovnoměrně vyzařuje jednu kandelu ve všech směrech, má celkový světelný tok
% $1 cd × 4πsr = 4π cd · sr ≈12.57 lm$
% \medskip
% Zdroj: https://www.ledyilighting.com/cs/candela-vs-lux-vs-lumens/
% ---------------------------------------------------------------------------------

% {\sbf Candela:}
% % Definice a~význam v měření světelné intenzity.

% Svítivost patří mezi fotometrické veličiny, která tedy vyjadřuje vlastnosti zdroje světla. Jednotkou  svítivosti je kandela (candela, cd), která je jednou ze základních jednotek soustavy SI.
% \medskip
% Jednotka svítivosti kandela je definována jako světelná intenzita v daném směru pocházející ze zdroje emitujícího monochromatické záření o frekvenci {\sbf 540.1012 Hz} a~jehož zářivost v tomto směru je {1/683} wattu na steradián {\sbf (W/sr)}.
...
% % Kandela je, zjednodušeně řečeno, síla světla v určitém směru od zdroje ve světelném kuželu, ještě přesněji v určitém prostorovém úhlu - tzv. steradiánu. Steradián (sr) je jednotka prostorového úhlu (Solid angle). Jeden steradián lze popsat jako kužel, který vznikne zdrojem světla ve středu koule o poloměru 1 m a~vytvoří na jejím povrchu plochu 1 m2. Vyjádřeno v ploše má 1 steradián úhel asi 66° a~povrch celé koule má 12,6 steradiánů (4π).

% % Svítivost 1 kandela je potom definována jako svítivost zeleného zdroje světla o vlnové délce 555 nm (na které je oko nejcitlivější) mající výkon 0,00146 wattů na 1 steradián.
% Zdroj: https://fyzmatik.pise.cz/45-jednotka-svitivosti-kandela.html

%popsat jak spolu tyto veliciny souvisi, nejlepe i~na obrazku   !!!!!!!!!!!!

% \medskip
% {\sbf Lumen:}
% % Vysvětlení a~význam při měření světelného toku.

% \medskip
% {\sbf Lux:}
% Význam v měření osvětlení na určité ploše.

% \ctable{lrrrrr}{
% \table{llllll}{
% %\hfil Spektrum & Vlnová délka \crl \tskip 4pt
% Specifikace & Candela & Lumen & Lux \cr
% Definice & Candela je úroveň jasu světelného zdroje v určitém úhlu a~směru. & Lumen udává celkový výkon světla ve všech směrech. & Množství osvětlení, které dopadá na metr čtvereční plochy, je Lux.\cr
% Měrná jednotka & & & \cr
% Symbol (SI) & & & \cr}
% }
