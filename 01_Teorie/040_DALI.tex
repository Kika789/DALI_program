...
tři základní typy zařízení, které se vyskytují na sběrnici v systému \glref{DALI}.

\medskip \clabel[dalicek]{Příklad struktury systému}
\picw=12cm \cinspic 03_Obrazky/dalicek.png
\caption/f Příklad struktury systému
...
Multi master \glref{DALI-2} má striktnější pravidla pro komunikaci. Jedním z příkladů je časování půl bitů:
\begitems
...
\medskip \clabel[kodovani]{Kodování bitů v protokolu \glref{DALI}}
\picw=8cm \cinspic 03_Obrazky/logika.png
\vbox{\caption/f Kodování bitů v protokolu \glref{DALI}}
...
\begitems
    *{\sbf Standardní:} Tyto pakety mohou mít délku 8, 16, 24 nebo 32 bitů a~jsou používány pro základní funkce protokolu \glref{DALI}.
    *{\sbf Rezervované:} Tyto pakety mají délku 20 bitů, jsou vyhrazeny a~nesmějí se používat.
    *{\sbf Privátní:} Tyto pakety definují výrobci zařízení a~slouží k~rozšíření funkcí protokolu \glref{DALI} o~specifické funkce daného výrobce.
...
Pro komunikaci mikropočítače ESP32 po sběrnici \glref{DALI} byl použit interface podle schématu na obr. \ref[schematic]
...
\begitems
    * Po spuštění mikropočítač nastaví výstupní port na 1, čímž uvede sběrnici do klidového stavu.
\enditems

\medskip \noindent
{\sbf Vstupní strana:}
\begitems
    * Vstupní strana je realizována oddělovačem OK1, Zenerovou diodou D1 a~omezovačem proudu IC1.
    * Celkový spád napětí na vstupu je cca 6,7 V (dioda 0,7 V, omezovač 1 V, Zenerova dioda 5 V)
