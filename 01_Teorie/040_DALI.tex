...
\begitems
    *{\sbf Single master:} Tyto jednotky jsou kompatibilní s \glref{DALI} v1 a~slouží jako hlavní řídicí prvek v systému.
...
\begitems
    ...
    * {\sbf Kombinace obou:} Můžete kombinovat hvězdicovou a~seriovou topologii.
...
\begitems
    ...
    *{\sbf Aktivní stav:} Při nízkém stavu vysílače a~odběru 250 mA nesmí výstupní napětí překročit než 4,5~V.
