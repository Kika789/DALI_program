...
\begitems
    * Pravá strana rozhraní slouží jako zdroj napájení pro řídící jednotku s \glref{ESP32}.
    * IC2 je synchronní step-down měnič napětí s obvodem TPS4005x \cite[tps4005x],
    který zajišťuje stabilní napájení 5 V pro \glref{ESP32}.
\enditems
...
\begitems
    * Propojka R10 umožňuje odpojit 5V napájení řídící jednotky, pokud se používá napájení z USB portu mikropočítače \glref{ESP32}.
    * Deska mikropočítače \glref{ESP32} obsahuje ochrannou diodu pro zdvojené napájení, takže propojku R10 není nutné odstraňovat.
\enditems
