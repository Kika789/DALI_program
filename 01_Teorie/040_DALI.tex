...
\begitems
    * Pokud je připojen USB kabel, mikropočítač je napájen z USB portu a~napájení z IC2 je odpojeno.
    * Deska mikropočítače \glref{ESP32} obsahuje ochrannou diodu pro případ zdvojeného napájení.
    * Propojka R10 ne nepoužívá.
\enditems
