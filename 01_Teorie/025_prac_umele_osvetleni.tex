...
*{\sbf Svítivost [I]} : 1 cd (kandela) -- Veličina udává, kolik světelného toku Φ vyzáří světelný zdroj nebo svítidlo
    do jednotkového prostorového úhlu Ω v~určitém směru (obr.~\ref[lcx]).
\enditems

    $$ I={{{\rm d} \it Φ} \over {\rm d} Ω}  \quad , \eqmark $$

\medskip
kde dΦ [lm] je světelný tok vyzařovaný do elementárního prostorového úhlu dΩ [sr].

\begitems
* {\sbf Světelný tok [Φ]} : 1 lm (lumen) --
