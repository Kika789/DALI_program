...
\begitems
    ...
    * {\sbf Liniová topologie:} Zařízení jsou propojena v řadě, kdy z jednoho zařízení vede kabel k dalšímu.
    * {\sbf Kombinace obou:} Můžete kombinovat hvězdicovou a liniovou topologii pro větší flexibilitu.
\enditems
...
\begitems
    ...
    *{\sbf Hrana signálu:} Náběžná a sestupní hrana signálu, by neměla být kratší než 3 µs, kvůli minimalizaci EMS rušení.
\enditems
...
Přenosový protokol DALI využívá k přenosu informace hrany signálu (obr. \ref[kodovani]).
Logické jedničce odpovídá vzestupná hrana signálu a nule dopovídá sestupní hrana signálu.

Komunikace po sběrnici je sice asynchronní, tedy bez synchronizačního signálu,
ale každá hrana signálu slouží současně k synchronizaci komunikace,
to znamená, že přijímací strana vždy měří délku pulzu od poslední hrany.
Tento typ kodovani je znám jako protokol Manchester.
...
* {\sbf Stop bit:} Klidový stav který trvá specifikovanou dobu, který označují konec rámce.
\enditems
