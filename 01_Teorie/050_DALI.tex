...
\begitems
    ...
    * Za vstupem je umístěn omezovač proudu s maximálním proudem při výstupu nakrátko 60 mA. To je dáno velikostí odporu R8 a~předpokladem úbytku napětí na něm cca 0,7 V.
...
\begitems
    ...
    * Za svorkami je umístěna ochrana proti přepólovaní napětí s tranzistorem Q3 P-MOSFET. Tato ochrana slouží i proti náhodnému zapojení obou zdrojů napájení.
\enditems
