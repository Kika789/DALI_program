    ...
    * Toto je obecný termín pro zařízení v systému DALI, které odesílá řídicí příkazy a~dotazy.
      Řídicí zařízení se dále dělí na dva typy:
        ...
        * {\sbf Application Controller} (Aplikační řadič): Hlavní řídicí jednotka v systému DALI,
            ...
            Může jím být například tlačítkový panel, počítač nebo inteligentní systém budovy (BMS).
...
\begitems
    *{\sbf Single master:} 366,7 µs až 466,7 µs (\cite[iec101], kapitola 8.1.1)
    *{\sbf Multi master:} 400,0 µs až 433,3 µs (\cite[iec101], kapitola 8.3.1)
\enditems
