...
slouží k~ovládání inteligentní světelné techniky.
Mezinárodní standart IEC~62386 pro \glref{DALI}, byl vyvinut jako náhrada za analogové
řízení osvětlovací s~flexibilním digitálním řídicím systémem.
Jedná se o~obousměrný komunikační protokol.
\glref{DALI} zařízení jsou adresovatelná, lze pro ně nastavovat skupinové funkce,
definovat jas scény a~dynamicky měnit intenzitu osvětlení.
...
\sec Názvosloví IEC~62386

Některé důležité pojmy podle standartu IEC~62386(\cite[iec101],\cite[iec102],\cite[iec103]) jsou:

\begitems
    * {\sbf Control Device} - Ovládací zařízení
    \begitems
        * {\sbf Application Controller} - Aplikační řadič
        * {\sbf Input Device} - Vstupní zařízení
    \enditems

    * {\sbf Control Gear} - Předřadný přístroj světelného zdroje
    * {\sbf Ballast} - Předřadník
\enditems
