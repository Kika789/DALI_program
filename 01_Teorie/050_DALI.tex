...
Pro komunikaci mikropočítače ESP32 po sběrnici DALI byl použit interface podle schématu na obr. \ref[schematic]
a interface pro napájení sběrnice podle schématu na obr. \ref[schematic2].
...
\medskip
\noindent
{\sbf Připojení sběrnice DALI:}
\begitems
    * Sběrnice DALI se připojuje ke svorkám X1-1 a X1-2.
        Polarita připojení nehraje roli.
    * K mikropočítači se sběrnice připojuje přes optické oddělení realizované optočleny IK1 a IK2 \cite[PC817].
\enditems
...
\begitems
    ...
    * Celkový spád napětí na vstupu je cca 6,7 V (dioda 0,7 V, omezovač 1 V, Zenerova dioda 5 V)
    a odpovídá normě, kde aktivní stav je 0 až 6,5 V.
\enditems
...
\begitems
    * Omezovač proudu IC1 je nastaven na proud 1 mA odporem R2 = 68 Ω. Norma povoluje odběr v klidovém stavu do 2 mA.
    Na druhou stranu, při tomto nastavení má IC1 poměrně nízkou rychlost změny signálu (pouze 1 V/μs),
    což může negativně ovlivnit čtení hodnot ze sběrnice DALI \cite[LM334].
\enditems
