...
\medskip\noindent
Umělé osvětlení dělíme na \cite[svetloaosvetlovani]:
...
\begitems
* {\bf Přímé osvětlení} - dopadá na osvětlovanou plochu přímo ze světelného zdroje.
* {\bf Nepřímé osvětlení} - osvětluje plochu odraženým světlem, které se odráží od stropu, stěn nebo jiných povrchů. Díky tomu se minimalizuje oslnění a tvorba stínů.
\enditems
...
\medskip
\noindent {\bf Činitele odrazu povrchů:}
...
\medskip
\noindent {\sbf 5 -- 7,5 -- 10 -- 15 -- 20 -- 30 -- 50 -- 75 -- 100 -- 150 -- 200 -- 300 --
...
\noindent {\bf Rovnoměrnost osvětlení}
