...
Vlnové délky světla se obvykle měří v~nanometrech (nm) \cite[jak_funguje_svetlo].
...
\begitems
* {\sbf Osvětlenost (intenzita osvětlení) [E]} : 1 lx (lux) -- Veličina udává, jak je určitá plocha osvětlována, tedy podíl
% t.j. kolik světelného toku dopadá na 1 $m^2$.
\enditems
