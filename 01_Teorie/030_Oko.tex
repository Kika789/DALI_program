...
Mezi světločivné buňky patří tyčinky (v počtu asi $130\cdot10^6$), čípky (asi $7\cdot10^6$) a ipRGC buňky, kde
...
Tento termín je důležité zmínit jedná se o škálu biologických reakcí v souvislosti se světlem. Mezi tyto
reakce patří například rozšiřování nebo zužování zornice, ovlivnění produkce melatoninu
nebo řízení cirkadiánního rytmu, či kognitivní funkce.

Zrak nám umožňuje vizuální informaci v mozku, ale

Toto tzv. nevizuální (nezrakové,
neobrazové) vnímání světla nevytváří žádný vizuální obraz v mozku, poskytuje pouze
informaci o přítomnosti nebo nepřítomnosti světla v našem prostředí [Foster & Hankins
2007].
